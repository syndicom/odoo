# -*- coding: utf-8 -*-
{
    ...
    'depends': ['base','syndicom_member_data_history','product','account','membership','helpdesk','syndicom_member_administration','hr_expense','announcement','event', 'website_event','website_event_social','hr_holidays'],
